...
import heroData from './hero-code.json'
    ...
    <>
      <div className="container">
        <div className="flex flex-wrap justify-between -mx-5">
          <div className="w-full lg:w-[45%] px-5 [&_h1]:text-white [&_h1]:leading-[1.2] max-lg:mb-10">
          ...
          <div className="w-full lg:w-[55%] px-5 hero-slider">
            <Swiper
              pagination={{
                clickable: true
              }}
